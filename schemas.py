...
class EstudianteBase(BaseModel):
    ...
    email: EmailStr = Field(..., description="Correo electrónico único del estudiante.")
...
class EstudianteUpdate(BaseModel):
    ...
    email: Optional[EmailStr] = Field(None, description="Correo electrónico (opcional). Debe ser único.")
